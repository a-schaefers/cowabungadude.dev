...
#+BEGIN_EXPORT html
<div class="badge-base LI-profile-badge" data-locale="en_US" data-size="large" data-theme="light" data-type="HORIZONTAL" data-vanity="adam-schaefers" data-version="v1"><a class="badge-base__link LI-simple-link" href="https://www.linkedin.com/in/adam-schaefers?trk=profile-badge">Adam Schaefers</a></div>
#+END_EXPORT
...
Recruiter note: I'm a blue-team, white hat guy -- I like to think of myself as one of the good guys!
...
Like any good cult, I found that tech has its own jargon and can give you sense of identity. There are even holy wars. (See Vim vs. Emacs and Tabs vs. Spaces, as brilliantly demonstrated in the T.V. sitcom Silicon Valley. [fn:h])
...
* TODO Devops at Immaculata Studios 2021 -- Present (Automation life)
...
* TODO Begin new ./blog/index.org section
...
* TODO Condense current writing / Cleanup, remove some lines (it's too long)

* TODO Certification journey

* TODO Current reading list
